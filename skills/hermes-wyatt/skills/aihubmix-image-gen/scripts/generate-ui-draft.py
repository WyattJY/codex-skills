...
def main() -> None:
    ...
    for env_file in [
        Path("/Users/jiangyu/.hermes-wyatt/.env"),
        Path("/Users/jiangyu/.hermes/.env"),
        *[Path(p) for p in args.env_file],
    ]:
    ...
    base_url = (
        os.environ.get("HERMES_UI_IMAGE_BASE_URL")
        or os.environ.get("AIHUBMIX_BASE_URL")
        or os.environ.get("OPENAI_BASE_URL")
        or "https://aihubmix.com/v1"
    )
    model = os.environ.get("HERMES_UI_IMAGE_MODEL") or os.environ.get("AIHUBMIX_IMAGE_MODEL") or "gpt-image-2"
    api_key = (
        os.environ.get("HERMES_UI_IMAGE_API_KEY")
