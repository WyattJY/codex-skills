...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default=".claude-review")
...
## Review Instructions
- Review independently in a fresh Claude Code context. Use a second external reviewer only if configured.
