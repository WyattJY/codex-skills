...
Claude Code's interactive `/model` menu is not the source of truth for wrapper-provided model IDs. For standalone sessions, prefer the wrapper commands documented in `/Users/jiangyu/.hermes-wyatt/AGENTS.md`.
